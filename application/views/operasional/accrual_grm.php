...
foreach ($bulan as $u) {
    ...
    if ($u == 01) {
        ...
        $bulanjumlah = 01;
            ...
            <?=form_open('Accrual_GRM/triggeredExport', ['class' => 'form-horizontal'])?>
...
<?=form_open('Accrual_GRM', ['class' => 'form-horizontal'])?>
<form role="form" class="form-horizontal">
		<form role="form" class="form-horizontal">
		<div class="row">
...
<div class="font-weight-bold text-uppercase mb-1">
                                    ...
                                    <br>
                                        ...
                                        <option value="<?php echo $u->DJPtanggalsertifikat ?>" <?php echo set_select('Tahun', "$u->DJPtanggalsertifikat"); ?>>
											<?php echo $u->DJPtanggalsertifikat; ?>
										</option>
