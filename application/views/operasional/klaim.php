        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Tanggal Klaim Bayar</label>
                  <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="date" class="form-control" id="tglklaimbayar" name="tglklaimbayar"
                        placeholder="">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" id="sertifikat" name="sertifikat" class="form-control"
                        value="" >
                </div>
            </div>
             ...
             <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" id="nmterjamin" name="nmterjamin" class="form-control"
                        value="" >
                </div>
            </div>
             ...
             <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" id="nilai_jaminan" name="nilai_jaminan" class="form-control"
                        value="" >
                </div>
            </div>
             ...
             <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" id="nominal_klaim" name="nominal_klaim" class="form-control"
                        value="" >
                </div>
            </div>
             ...
             <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" name="agunan" class="form-control"
                        value="" >
                </div>
            </div>
             ...
             <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" name="taksasi_agunan" class="form-control"
                        value="" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" name="Jkwaktu" class="form-control"
                        value="" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" name="cover_reas" class="form-control"
                        value="" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" name="klaim_reas" class="form-control"
                        value="" >
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" name="broker" class="form-control"
                        value="" >
                </div>
            </div>
