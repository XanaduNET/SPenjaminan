        ...
        <table cellspacing="0" style="width: 85%; text-align: right; ">
            <tr>
                <td style="width:100%;" align="left">
                    <span style="font-weight: bold; color: #000000">Lampiran Entry Data Registrasi DJP (BARU) Nomor
                        :</span>
...
foreach ($table as $u) {?>
	...
	$DJPnoreg = $u->DJPnoreg;
        ...
        <table cellspacing="0" style=" width: 100%; ">
            <tr>
                <td style="font-weight: bold;  width:100%;">
                    <div align="left"> PENERIMA JAMINAN</div>
                </td>
                <td style="width:0%;">
                    <div align="left">:</div>
                </td>
        ...
        <table cellspacing="0" style=" width: 100%; ">
            <tr>
                <td style="font-weight: bold;  width:100%;">
                    <div align="left"> Jenis Kredit</div>
                </td>
                <td style="width:0%;">
                    <div align="left">:</div>
                </td>
