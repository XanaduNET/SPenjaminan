        ...
        <div>
            ...
            <form role="form" class="form-horizontal">
                ...
                <input type="hidden" id="bulan" name="bulan"
                    value="<?php echo htmlspecialchars(json_encode($bulanmax)) ?>" />
...
foreach ($table as $u) {?>
                                    <tr>
                                        ...
                                        <td><?php echo "Rp." . number_format($u->DJPDfeebank, 0, ".", "."); ?></td>
                                        <td><?php echo "Rp." . number_format($angsuran = (int) ($u->DJPDfeebank / $u->DJPDjangkawaktu), 0, ".", "."); ?>
                                        </td>
                                        <?php
$tglawal = date('Y-01');
