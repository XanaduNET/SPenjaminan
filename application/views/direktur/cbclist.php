                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?=base_url("casebc/CBCpdf/");?><?=$c['CBCid'];?>"
                                            ...
                                            &nbsp;
                                            <a href="#" data-toggle="modal" data-target="#modalcbc" class="badge badge-info">Berkas</a>
                                    </td>
                                    <td>
                                    <?php
...
foreach ($upld as $u) {
    ?>
<a href="../../uploads/<?=$u['UPLDnama']?>"><?=$u['UPLDnama']?></a><br>
                                        <?php
}
?>
                </div>
...
<tr>
    ...
    <td>
        <a href="<?=base_url("casebc/CBCPpdf/");?><?=$c['CBCPid'];?>"
            class=" badge badge-primary">Detail</a>
            &nbsp;
        <a href="#" data-toggle="modal" data-target="#modalcbcp" class="badge badge-info">Berkas</a>
