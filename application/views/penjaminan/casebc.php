        ...
        <form role="form" class="form-horizontal">
            ...
            <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCnomormemo" id="CBCnomormemo" class="form-control">
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="text" name="CBCplafondkredit" id="CBCplafondkredit" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div     class="form-group col-lg-3 col-sm-4">
                    <input style="width: 100%;" type="number" name="CBCangsurankredit" id="CBCangsurankredit" class="form-control">
                    </div>
                </div>
                <hr class="sidebar-divider">
