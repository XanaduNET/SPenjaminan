...
<span style="font-size: 11pt;  color: #000000;">Menunjuk surat <?php echo $u->PPnama; ?>  Nomor : <?php echo $u->CBCnomormemo; ?>  Tanggal 16 April 2021 dimana berdasarkan hasil analisa dan persetujuan komite penjaminan PT. Jamkrida Riau, maka dengan ini kami sampaikan bahwa pada prinsipnya kami dapat menyetujui penjaminan kredit yang diajukan sebesar nilai plafond data sebagai berikut:</span>
</div>
<br>
<!-- Paragraf 2 End -->
<!-- Paragraf 3 -->
