...
<body>
    ...
    <div id="header">
        <table cellspacing="0" style="width: 100%; ">
            <tr>
                <td><img src="<?php echo base_url('assets/images/bground.png'); ?>" width="200px" height="100px" />
                </td>
                <td width="100%"><span style="font-weight: bold; font-size: 14pt;  color: #000000"> PT. PENJAMINAN
                        KREDIT DAERAH PROVINSI RIAU<br>(PT. JAMKRIDA RIAU)</span>
                    <span style=" font-size: 8pt;  color: #000000"><br>Jl. Sumatera No. 25 Pekanbaru, Kel. Simpang
                        Empat, Kec. Pekanbaru Kota, telp/fax. 0761-7871467
...
foreach ($table->result() as $u) {
	?>
        <table cellspacing="0" style="width: 100%; text-align: left; ">
            <tr>
                ...
                <td width="60%" style="vertical-align: top;">
                    ...
                    <span style="font-size: 11pt;  color: #000000">Perihal&nbsp;&nbsp;:&nbsp;Persetujuan Penjaminan
                        Kredit </span><br>
                ...
                <td>
                    ...
                    <span style="font-size: 11pt;  color: #000000">Kepada Yth : <br> PT. Bank Riau Kepri <br>
                        <?php echo $u->PPnama; ?> <br> di - <br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php echo $u->DAERAHnama ?></span>
        ...
        <div style="text-align: justify">
            <span style="font-size: 11pt;  color: #000000;">Menunjuk surat <?php echo $u->PPnama; ?> Nomor :
                <?php echo $u->CBCnomormemo; ?> Tanggal 16 April 2021 dimana berdasarkan hasil analisa dan persetujuan
                komite penjaminan PT. Jamkrida Riau, maka dengan ini kami sampaikan bahwa pada prinsipnya kami dapat
                menyetujui penjaminan kredit yang diajukan sebesar nilai plafond data sebagai berikut:</span>
        </div>
        <br>
        <!-- Paragraf 2 End -->
        <!-- Paragraf 3 -->
        <span style="font-size: 11pt;  color: #000000;">
            <table cellspacing="0" style="width: 100%; text-align: left; ">
                ...
                <tr>
                    ...
                    <td width="2%"> : </td>
                    <td width="60%"><?php echo "Rp." . number_format($u->CBCplafondkredit, 0, ".", "."); ?></td>
                </tr>
                <tr>
                    <td width="2%"> - </td>
                ...
                <tr>
                    ...
                    <td width="2%"> : </td>
                    <td width="60%"><?php echo $u->CBCjwk; ?></td>
                </tr>
                <tr>
                    <td width="2%"> - </td>
                    <td width="36%"> Rate IJP </td>
                    <td width="2%"> : </td>
                    <td width="60%">30,71‰</td>
                </tr>
                <tr>
                    <td width="2%"> - </td>
        ...
        <span style="font-size: 11pt;  color: #000000">
            <table cellspacing="0" style="width: 100%; text-align: left; ">
                ...
                <tr>
                    <td>
                        (30.71‰ x <?php echo "Rp." . number_format($u->CBCplafondkredit, 0, ".", "."); ?>)
                    </td>
                    <td></td>
                    <td> = &nbsp;&nbsp;&nbsp; <?php $hasil = (30.71 / 1000) * $u->CBCplafondkredit;
...
function Terbilang($satuan)
	...
	?>
            ...
            <table cellspacing="0" style="width: 100%; text-align: left; ">
                <tr>
                    <td>
                        Selanjutnya pembayaran biaya penjaminan tersebut harap dilimpahkan ke rekening PT. Jamkrida Riau
                        No. 101.20.03064 di BANK RIAU KEPRI CABANG UTAMA.<br>
                        <br>
                        Konfirmasi Bapak mengenai Persetujuan Prinsip harap dikirim kepada kami selambat-lambatnya 7
                        (tujuh) hari kerja sejak diterimanya surat ini. Pengiriman melebihi batas waktu tersebut tidak
                        mengikat Penjamin untuk menerbitkan Sertifikat Penjaminan Kredit.
                        <br>
                        <br>
