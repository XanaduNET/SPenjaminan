    <div class="container-fluid">
            ...
            <form role="form" class="form-horizontal">
                ...
                <div class="form-group row">
                        ...
                        <input type="text" name="CBCid" class="form-control" id="CBCid" value="<?=$this->uri->segment(3);?> " hidden>
                            <input style="width: 100%;" value="<?=$table['CBCnomormemo'];?>" type="text" name="CBCnomormemo" id="CBCnomormemo" class="form-control">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" name="TRJMid" class="form-control" id="TRJMid" value="<?=$table['TRJMid'];?> " hidden>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMalamat" id="TRJMalamat" class="form-control"value="<?=$table['TRJMalamat'];?> " >
                        </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCjenis" id="CBCjenis" value="<?=$table['CBCjenis'];?> " class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCplafondkredit" id="CBCplafondkredit" class="form-control" value="<?=$table['CBCplafondkredit'];?> ">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCjwk" id="CBCjwk" value="<?=$table['CBCjwk'];?> " class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div     class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="number" name="CBCangsurankredit" id="CBCangsurankredit" value="<?=$table['CBCangsurankredit'];?>" class="form-control">
                        </div>
                    </div>
                    <hr class="sidebar-divider">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            ...
                            <input type="text" name="PPnama" class="form-control" id="PPnama" value="<?=$table['PPnama'];?> ">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Alamat Bank </label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="PPalamat" class="form-control"  readonly>  <?php echo $table['PPalamat']; ?> </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Telp/Fax</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="PPtelpon" value="<?=$table['PPtelpon'];?> "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <textarea name="CBCaspek_kesehatan" class="form-control"> <?php echo $table['CBCaspek_kesehatan']; ?> </textarea>
                        </div>
                    </div>
                    <hr class="sidebar-divider">
                    <!-- End Data Permohonan Kredit -->
                    ...
                    <label class="col-sm-2 col-form-label">Aspek Agunan / Jaminan</label>
                        <div class="form-group col-lg-3 col-sm-4">
                        <textarea name="CBCaspek_agunan"  class="form-control"><?php echo $table['CBCaspek_agunan']; ?></textarea>
                    </div>
                    </div>
                    <hr class="sidebar-divider">
                    <!-- End Data Permohonan Kredit -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <textarea name="CBCaspek_pinjaman"  class="form-control"><?php echo $table['CBCaspek_pinjaman']; ?></textarea>
                        </div>
                    </div>
                    <hr class="sidebar-divider">
                    <!-- End Data Permohonan Kredit -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <textarea name="CBCkesimpulan"  class="form-control"><?php echo $table['CBCaspek_agunan']; ?></textarea>
                        </div>
                    </div>
                        <!-- End Data Permohonan Kredit -->
