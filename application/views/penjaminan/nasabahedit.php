...
foreach ($DJPD->result_array() as $djpdqry) {
    ...
    ?>
                                            <tr>
                                                ...
                                                <td><input type="text" id="TRJMalamat<?=$i;?>" name="TRJMalamat<?=$i;?>"
                                                        class="TRJMalamat" value="<?=$djpdqry['TRJMalamat'];?>"></td>
                                                <td><input type="text" id="TRJMusia<?=$i;?>" name="TRJMusia<?=$i;?>"
...
$trjmid = (string) $djpdqry['TRJMid'];
    ...
    foreach ($TRJM->result_array() as $trjmqry) {
        ?>
                                                ...
                                                <td><input type="text" id="TRJMktp<?=$i;?>" name="TRJMktp<?=$i;?>"
                                                        class="TRJMktp" value="<?=$trjmqry['TRJMktp'];?>"></td>
                                                <td><input type="text" id="TRJMnpwp<?=$i;?>" name="TRJMnpwp<?=$i;?>"
                                                        class="TRJMnpwp" value="<?=$trjmqry['TRJMnpwp'];?>"></td>
                                                <?php }?>
                                                <input style="width: 100%;" type="hidden" name="DJPid<?=$i;?>"
                                                    id="DJPid<?=$i;?>" class="DJPid" class="form-control"
                                                    value="<?php echo $this->uri->segment(3) ?> " readonly>
                                                <input style="width: 100%;" type="hidden" name="OPKid<?=$i;?>"
                                                    id="OPKid<?=$i;?>" class="form-control"
    ...
    ?> <div id="loading" style="margin-top: 15px;">
                                                ...
                                                <td><input type="text" id="DJPDnoakad<?=$i;?>" name="DJPDnoakad<?=$i;?>"
                                                        class="DJPDnoakad" value="<?=$djpdqry['DJPDnoakad'];?>"></td>
                                                <td><input type="date" id="DJPDtanggalakad<?=$i;?>"
                                                        name="DJPDtanggalakad<?=$i;?>" class="DJPDtanggalakad"
                                                        onchange='(copytextbox<?=$i;?>())'
                                                        value="<?=$djpdqry['DJPDtanggalakad'];?>"></td>
                                                <td><input type="text" id="DJPDjangkawaktu<?=$i;?>"
                                                        name="DJPDjangkawaktu<?=$i;?>" class="DJPDjangkawaktu"
                                                        value="<?=$djpdqry['DJPDjangkawaktu'];?>">
                                                </td>
                                                <td><input type="date" id="DJPDtanggalawal<?=$i;?>"
                                                        name="DJPDtanggalawal<?=$i;?>" class="DJPDtanggalawal" readonly
                                                        value="<?=$djpdqry['DJPDtanggalawal'];?>"></td>
                                                <td><input type="date" id="DJPDtanggalakhir<?=$i;?>"
                                                        name="DJPDtanggalakhir<?=$i;?>" class="DJPDtanggalakhir"
                                                        readonly value="<?=$djpdqry['DJPDtanggalakhir'];?>"></td>
                                                <td><input type="text" id="DJPDplafondkredit<?=$i;?>"
                                                        name="DJPDplafondkredit<?=$i;?>" class="DJPDplafondkredit"
                                                        value="<?=$djpdqry['DJPDplafondkredit'];?>"></td>
                                                <td><input type="text" id="DJPDcoverage<?=$i;?>"
                                                        name="DJPDcoverage<?=$i;?>" class="DJPDcoverage"
                                                        onchange="(HitungPersendanRate<?=$i;?>())"
                                                        value="<?=$djpdqry['DJPDcoverage'];?>"></td>
                                                <td><input type="text" id="DJPDnilaipenjaminan<?=$i;?>"
                                                        name="DJPDnilaipenjaminan<?=$i;?>" class="DJPDnilaipenjaminan"
                                                        value="<?=$djpdqry['DJPDnilaipenjaminan'];?>" readonly></td>
                                                <td><input type="text" id="DJPDrate<?=$i;?>" name="DJPDrate<?=$i;?>"
                                                        class="DJPDrate" value="<?=$djpdqry['DJPDrate'];?>"></td>
                                                <td><input type="text" id="DJPDimbaljasa<?=$i;?>"
                                                        name="DJPDimbaljasa<?=$i;?>" class="DJPDimbaljasa" readonly
                                                        value="<?=$djpdqry['DJPDimbaljasa'];?>"></td>
                                                <td><input type="text" id="DJPDtujuankredit<?=$i;?>"
                                                        value="<?=$djpdqry['DJPDtujuankredit'];?>"
                                                        name="DJPDtujuankredit<?=$i;?>" class="DJPDtujuankredit">
                                                </td>

                                                <td><input type="text" id="DJPDjenisagunan<?=$i;?>"
                                                        name="DJPDjenisagunan<?=$i;?>" class="DJPDjenisagunan"
                                                        value="<?=$djpdqry['DJPDjenisagunan'];?>"></td>
                                                <td><input type="text" id="DJPDcarapengikatan<?=$i;?>"
                                                        name="DJPDcarapengikatan<?=$i;?>" class="DJPDcarapengikatan"
                                                        value="<?=$djpdqry['DJPDcarapengikatan'];?>"></td>
                                                <td><input type="text" id="DJPDnilaitransaksipasar<?=$i;?>"
                                                        name="DJPDnilaitransaksipasar<?=$i;?>"
                                                        class="DJPDnilaitransaksipasar"
                                                        value="<?=$djpdqry['DJPDnilaitransaksipasar'];?>"></td>
                                                <td><input type="text" id="DJPDnilaitransaksilikuidasi<?=$i;?>"
                                                        name="DJPDnilaitransaksilikuidasi<?=$i;?>"
                                                        class="DJPDnilaitransaksilikuidasi"
                                                        value="<?=$djpdqry['DJPDnilaitransaksilikuidasi'];?>"></td>
                                                <td><input type="text" id="DJPDsu<?=$i;?>" name="DJPDsu<?=$i;?>"
                                                        class="DJPDsu" value="<?=$djpdqry['DJPDsu'];?>"></td>
                                                <td><input type="text" id="DJPDobjekpenjaminan<?=$i;?>"
                                                        name="DJPDobjekpenjaminan<?=$i;?>" class="DJPDobjekpenjaminan"
                                                        value="<?=$djpdqry['DJPDobjekpenjaminan'];?>"></td>
                                            ...
                                            $(function() {
                                                ...
                                                $('#formnasabah').on('submit', function(e) {
                                                    ...
                                                    var DJPDplafondkredit = $('#DJPDplafondkredit')
                                                    .val();
                                                    var DJPDnilaipenjaminan = $('#DJPDnilaipenjaminan')
                                                        .val();
                                                    ...
                                                    var DJPDcarapengikatan = $('#DJPDcarapengikatan')
                                                        .val();
                                                    var DJPDnilaitransaksipasar = $(
                                                        '#DJPDnilaitransaksipasar').val();
                                                    var DJPDnilaitransaksilikuidasi = $(
                                                        '#DJPDnilaitransaksilikuidasi').val();
                                                    var DJPDsu = $('#DJPDsu').val();


                                                    if (TRJMnama.length == 0 || TRJMalamat.length ==
                                                        0 || TRJMusia.length == 0 || TRJMsiup.length ==
                                                        0 || TRJMktp.wlength == 0 || TRJMnpwp.length ==
                                                        0 || PKRJid.length == 0 || DJPDnoakad.length ==
                                                        0 || DJPDtanggalakad.length == 0 ||
                                                        DJPDjangkawaktu.length == 0 || DJPDtanggalawal
                                                        .length == 0 || DJPDtanggalakhir.length == 0 ||
                                                        DJPDplafondkredit.length == 0 ||
                                                        DJPDnilaipenjaminan.length == 0 || DJPDcoverage
                                                        .length == 0 || DJPDrate.length == 0 ||
                                                        DJPDimbaljasa.length == 0 || DJPDtujuankredit
                                                        .length == 0 || DJPDjenisagunan.length == 0 ||
                                                        DJPDcarapengikatan.length == 0 ||
                                                        DJPDnilaitransaksipasar.length == 0 ||
                                                        DJPDnilaitransaksilikuidasi.length == 0 ||
                                                        DJPDsu.length == 0) {
                                            ...
                                            function copytextbox<?=$i;?>() {
                                                document.getElementById('DJPDtanggalawal<?=$i;?>').value = document
                                                    .getElementById('DJPDtanggalakad<?=$i;?>').value;
                                            }
                                            </script>
                                            <!-- END -->
                                            <!-- SCRIPT AUTO -->
                                            ...
                                            function HitungPersendanRate<?=$i;?>() {
                                                var plafond = document.getElementById('DJPDplafondkredit<?=$i;?>')
                                                .value;
                                                ...
                                                document.getElementById("DJPDnilaipenjaminan<?=$i;?>").value =
                                                nilaipnjm;
                                                ...
                                                if (nilaipnjm != null) {
                                                    $.ajax({
                                                        ...
                                                        success: function(data) {
                                                            ...
                                                            document.getElementById('DJPDrate<?=$i;?>')
                                                                .value = data2[0].IJPrate
                                                            document.getElementById('DJPDimbaljasa<?=$i;?>')
                                                                .value = data2[0].IJPhasil
                                                        }
                                                    });
                                            ...
                                            $('#DJPDjangkawaktu<?=$i;?>').on('change', function() {
                                                const tglawal = document.getElementById(
                                                    'DJPDtanggalawal<?=$i;?>').value;
                                                const jwk = document.getElementById('DJPDjangkawaktu<?=$i;?>')
                                                    .value;
                                            ...
                                            <script>
                                            var DJPDplafondkreditrubah = document.getElementById(
                                                "DJPDplafondkredit<?=$i;?>");
                                            ...
                                            var DJPDnilaipenjaminanrubah = document.getElementById(
                                                "DJPDnilaipenjaminan<?=$i;?>");
                                            ...
                                            var DJPDnilaitransaksipasarrubah = document.getElementById(
                                                "DJPDnilaitransaksipasar<?=$i;?>");
                                            ...
                                            DJPDnilaitransaksilikuidasirubah.addEventListener("click", function(e) {
                                                DJPDnilaitransaksilikuidasirubah.value = convertRupiah(this
                                                    .value);
                                            });
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row " style="text-align:right">
                                        ...
                                        <div class="col ml-auto">
                                            <input style="width: 100%;" type="text" id="DJPmaxnilai" name="DJPmaxnilai"
                                                class="DJPmaxnilai" value="<?=$djpqry['DJPmaxnilai']?>" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" name="DJPtahun" class="DJPtahun"
                                                id="DJPtahun" value="<?=$djpqry['DJPtahun']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" name="DJPpk" id="DJPpk"
                                                class="DJPpk" value="<?=$djpqry['DJPjumlahpk']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" id="DJPjumlahnilaipk"
                                                name="DJPjumlahnilaipk" class="DJPjumlahnilaipk"
                                                value="<?=$djpqry['DJPjumlahnilaipk']?>" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" class="DJPnilaipenjaminan"
                                                data-dropdown-css-class="select2-danger" id="DJPnilaipenjaminan"
                                                name="DJPnilaipenjaminan" value="<?=$djpqry['DJPnilaipenjaminan']?>"
                                                placeholder="">
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" class="DJPjumlahimbaljasa"
                                                id="DJPjumlahimbaljasa" name="DJPjumlahimbaljasa"
                                                value="<?=$djpqry['DJPjumlahimbaljasa']?>" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" id="DJPfeebank" name="DJPfeebank"
                                                class="DJPfeebank" value="<?=$djpqry['DJPfeebank']?>" placeholder="">
                                            <input style="width: 100%;" type="text" id="DJPjumlahfeebank"
                                                name="DJPjumlahfeebank" class="DJPjumlahfeebank" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" class="DJPfeematerai"
                                                id="DJPfeematerai" name="DJPfeematerai"
                                                value="<?=$djpqry['DJPfeematerai']?>" placeholder="" value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" class="DJPfeeadmin" id="DJPfeeadmin"
                                                name="DJPfeeadmin" value="<?=$djpqry['DJPfeeadmin']?>" placeholder=""
                                                value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="text-align:right">
                                        ...
                                        <div class="col md-auto">
                                            <input style="width: 100%;" type="text" class="DJPjumlahbiaya"
                                                ...
                                                value="<?=$djpqry['DJPjumlahbiaya']?>">
                                            <input style="width: 100%;" type="hidden" name="DJPid" id="DJPid"
                                                class="DJPid" value="<?php echo $this->uri->segment(3) ?> " readonly>
                                    ...
                                    $('#DJPjumlahimbaljasa').on('click', function() {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                ...
                                                document.getElementById('DJPmaxnilai').value =
                                                    data2[0].nilaipert;
                                                document.getElementById('DJPtahun').value =
                                                    new Date().getFullYear();
                                                document.getElementById('DJPpk').value = data2[0]
                                                    .jumlahPK;
                                                document.getElementById('DJPjumlahnilaipk').value =
                                                    data2[0].plafond;
                                                document.getElementById('DJPnilaipenjaminan')
                                                    .value = data2[0].nilaipenjaminan;
                                                document.getElementById('DJPjumlahimbaljasa')
                                                    .value = data2[0].imbaljasa;
                                                var DJPjumlahimbaljasarubah = document
                                                    .getElementById("DJPjumlahimbaljasa");
                                                DJPjumlahimbaljasarubah.addEventListener(
                                                    "mouseover",
                                                    function(e) {
                                                        DJPjumlahimbaljasarubah.value =
                                                            convertRupiah(this.value);
                                                    });
                                                DJPjumlahimbaljasarubah.addEventListener(
                                                    'mouseover',
                                                    function(event) {
                                                ...
                                                if (($("#check_feebank").prop("checked") == true) &&
                                                    ($("#check_materai").prop("checked") == true)) {
                                                    document.getElementById('DJPfeebank').value =
                                                        data2[0].feebank;
                                                ...
                                                } else if (($("#check_feebank").prop("checked") ==
                                                        false) && ($("#check_materai").prop(
                                                        "checked") == true)) {
                                                    $jumlahfeebank = 0;
                                                    ...
                                                    document.getElementById('DJPfeebank').value =
                                                        "0%";
                                                    document.getElementById('DJPjumlahfeebank')
                                                        .value = 0;
                                                } else if (($("#check_feebank").prop("checked") ==
                                                        true) && ($("#check_materai").prop(
                                                        "checked") == false)) {
                                                    document.getElementById('DJPfeematerai').value =
                                                        0;
                                                ...
                                                $adm = parseInt(document.getElementById(
                                                    'DJPfeeadmin').value);
                                                $materai = parseInt(document.getElementById(
                                                    'DJPfeematerai').value);
                                                document.getElementById('DJPjumlahfeebank').value =
                                                    $jumlahfeebank;
                                                $jumlahbiaya = ($imbaljasa - $jumlahfeebank) +
                                                    $materai + $adm;
                                                var jumlahterbilang = $jumlahbiaya;
                                                document.getElementById('DJPjumlahbiaya').value =
                                                    $jumlahbiaya;
