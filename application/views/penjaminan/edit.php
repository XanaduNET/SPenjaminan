                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        <select class="form-control select2" id="DJPacuanhitung" name="DJPacuanhitung"
                            style="width: 70%;">
                            <option value="<?=$djpsertif['DJPacuanhitung'];?>"><?=$djpsertif['DJPacuanhitung'];?></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        <select class="form-control" name="GPPid" id="GPPid">
                            <option selected="<?=$djpsertif['GPPid'];?>" value="<?=$djpsertif['GPPid'];?>"> <?=$djpsertif['GPPnama'];?></option>
                            <?php
...
?>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        ...
                        ?>
                            <option selected="<?=$djpsertif['PKSid'];?>" value="<?=$djpsertif['PKSid'];?>"><?=$djpsertif['PKSno1'];?></option>
                        <?php }
                        ?>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        <input type="text" name="PPid" class="form-control" id="PPid" value="<?=$djpsertif['PPid'];?>"hidden>
                        <input type="text" name="PPnama" class="form-control" id="PPnama" value="<?=$djpsertif['PPnama'];?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Alamat Penjaminan</label>
                    <div class="form-group col-lg-3 col-sm-4">
                        <input type="text" name="PPalamat" class="form-control" id="PPalamat" value="<?=$djpsertif['PPalamat'];?>" readonly></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <option selected="<?=$djpsertif['DJPperiode'];?>" value="<?=$djpsertif['DJPperiode'];?>"><?=$djpsertif['DJPperiode'];?></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        <select class="form-control select2" id="OPKid" name="OPKid" style="width: 100%;">
                            <option selected="<?=$djpsertif['OPKid'];?>" value="<?=$djpsertif['OPKid'];?>"><?=$djpsertif['OPKjenis'];?></option>
                            <?php
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        <select class="form-control select2" id="SPJid" name="SPJid" style="width: 100%;">
                            <option selected="<?=$djpsertif['SPJid'];?>" value="<?=$djpsertif['SPJid'];?>"><?=$djpsertif['SPJnama'];?></option>
                            <?php
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-lg-3 col-sm-4">
                        <select class="form-control select2" id="JSPid" name="JSPid" style="width: 100%;">
                            <option selected="<?=$djpsertif['JSPid'];?>" value="<?=$djpsertif['JSPid'];?>"><?=$djpsertif['JSPjenis'];?></option>
                            <?php
