    ...
    $(document).ready(function(){
        ...
        $("#add").click(function(){
        i++;
        $('#formclone').append('<div class="cloning'+i+'"> <div class="form-group row"><label class="col-sm-2 col-form-label">Deskripsi Agunan / Jaminan</label></div><div class="form-group row"><label class="col-sm-2 col-form-label">Jenis Agunan/Jaminan</label><div class="form-group col-lg-3 col-sm-4"><textarea name="CBCPjenisagunan'+i+'" class="form-control"></textarea></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Nilai Tasaksi Agunan</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPnilaitasaksi'+i+'" name="CBCPnilaitasaksi'+i+'"><input style="width: 100%;" type="text" class="form-control" id="CBCPnilaitasaksitanah'+i+'"name="CBCPnilaitasaksitanah'+i+'" placeholder="Tanah/m"><input style="width: 100%;" type="text" class="form-control" id="CBCPnilaitasaksibangunan'+i+'"name="CBCPnilaitasaksibangunan'+i+'" placeholder="Bangunan"></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Nilai Dasar Agunan</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPnilaidasar'+i+'" name="CBCPnilaidasar'+i+'"><input style="width: 100%;" type="text" class="form-control" id="CBCPnilaidasartanah'+i+'"name="CBCPnilaidasartanah'+i+'" placeholder="Nilai Dasar Tanah/m"><input style="width: 100%;" type="text" class="form-control" id="CBCPnilaidasarbangunan'+i+'"name="CBCPnilaidasarbangunan'+i+'" placeholder="Nilai Dasar Bangunan"><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button> </div></div></div>');
        });
    ...
    $(document).ready(function(){
        ...
        i++;
        $('#formslikojk').append('<div class="cloningojk'+i+'"><div class="form-group row"><label class="col-sm-2 col-form-label">Analisa Dokumen Identitas</label><div class="form-group col-lg-3 col-sm-4"><textarea name="CBCPanalisadokumenidentitas'+i+'" class="form-control"></textarea></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Analisa Slik OJK</label><div class="form-group col-lg-3 col-sm-4"><textarea name="CBCPanalisaslikojk'+i+'" class="form-control"></textarea></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Bank Umum</label></div><div class="form-group row"><label class="col-sm-2 col-form-label">Nama Bank</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;"type="text"class="form-control"id="CBCPnamabank'+i+'"name="CBCPojknamabank'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Jangka Waktu</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPojkjangkawaktu'+i+'"name="CBCPojkjangkawaktu'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Plafond Kredit</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text"class="form-control" id="CBCPojkplafondkredit'+i+'"name="CBCPojkplafondkredit'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Tunggakan Pokok</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPojktunggakanpokok'+i+'"name="CBCPojktunggakanpokok'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Tunggakan Bunga</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPojktunggakanbunga'+i+'"name="CBCPojktunggakanbunga'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Angsuran</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%"type="text"class="form-control"id="CBCPojkangsuran'+i+'"name="CBCPojkangsuran'+i+'" placeholder=""></div></div> <div class="form-group row"><label class="col-sm-2 col-form-label">Kualitas</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;"type="text"class="form-control"id="CBCPojkkualitas'+i+'"name="CBCPojkkualitas'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Kondisi</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPojkkondisi'+i+'" name="CBCPojkkondisi'+i+'" placeholder=""><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_ojk">X</button> </div></div></div>');
        });
    ...
    $(document).ready(function(){
        ...
        i++;
        $('#cloningpendapatan').append('<div class="cloningpendapatan'+i+'">  <div class="form-group row"><label class="col-sm-2 col-form-label">Sumber Pendapatan</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPsumberpendapatan'+i+'"name="CBCPsumberpendapatan'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Nama Pendapatan</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPnamapendapatan'+i+'"name="CBCPnamapendapatan'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Pendapatan /bulan</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control" id="CBCPpendapatanbulan'+i+'"name="CBCPpendapatanbulan'+i+'" placeholder=""></div></div><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_pendapatan">X</button></div></div></div>');
        });
    ...
    $(document).ready(function(){
        ...
        i++;
        $('#cloningpengeluaran').append('<div class="cloningpengeluaran'+i+'"><div class="form-group row"><label class="col-sm-2 col-form-label">Nama Pengeluaran</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;" type="text" class="form-control"id="CBCPnamapengeluaran'+i+'"name="CBCPnamapengeluaran'+i+'" placeholder=""></div></div><div class="form-group row"><label class="col-sm-2 col-form-label">Pengeluaran /bulan</label><div class="form-group col-lg-3 col-sm-4"><input style="width: 100%;"type="text"class="form-control"id="CBCPpengeluaranbulan'+i+'"name="CBCPpengeluaranbulan'+i+'" placeholder=""></div></div><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_pengeluaran">X</button></div></div></div>');
        });
    ...
    <div class="container-fluid">
            ...
            <form role="form" id="formcbcproduktif" class="form-horizontal">
                ...
                <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="CBCPnomormemo" id="CBCPnomormemo" class="form-control">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Prinsipal</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="CBCPprinsipal" id="CBCPprinsipal" class="form-control">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMalamat" id="TRJMalamat" class="form-control">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Alamat Saat Ini</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMalamatsekarang" id="TRJMalamatsekarang" class="form-control">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Pekerjaan</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMpekerjaan" id="TRJMpekerjaan" class="form-control">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Jenis Usaha</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMusaha" id="TRJMusaha" class="form-control">
                        </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMstatuspernikahan" id="TRJMstatuspernikahan" class="form-control">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nama Suami/Istri</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMpartner" id="TRJMpartner" class="form-control">
                        </div>
                        </div>
                        <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Alamat Sesuai KTP</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMalamatpartner" id="TRJMalamatpartner" class="form-control">
                        </div>
                        </div>
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMpekerjaanpartner" id="TRJMpekerjaanpartner" class="form-control">
                        </div>
                        </div>
                        <hr class="sidebar-divider">
                        <!-- End Body Terjamin -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCPjenis" id="CBCPjenis" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCPsifat" id="CBCPsifat" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCPplafondkredit" id="CBCPplafondkredit" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" name="CBCPcoverage" id="CBCPcoverage" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div     class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="number" name="CBCPangsurankredit" id="CBCPangsurankredit" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div     class="form-group col-lg-3 col-sm-4">
                        <textarea name="CBCPrencanakredit" id="CBCPrencanakredit" class="form-control"  rows="4" cols="50">
                        </textarea>
                        </div>
                    </div>
                    <hr class="sidebar-divider">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <textarea name="CBCPdeskripsisumberpendapatan" id="CBCPdeskripsisumberpendapatan" class="form-control"></textarea>
                        </div>
                    </div>
                    <hr class="sidebar-divider">
            ...
            <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaitasaksi[]" name="CBCPnilaitasaksi[]">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                        <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaidasar[]" name="CBCPnilaidasar[]">
