                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?=base_url("casebc/CBCpdf/");?><?=$c['CBCid'];?>"
                                            ...
                                            &nbsp;
                                            <a href="#" data-toggle="modal" data-target="#modalcbc" class="badge badge-danger">Upload Dokumen</a>
                                            &nbsp;
...
<br>
<input class="form-check-input" type="checkbox" value="1" name="doc_lengkap" id="doc_lengkap"
                                checked>
<br>
...
<tr>
    ...
    <td>
        <a href="<?=base_url("casebc/CBCPpdf/");?><?=$c['CBCPid'];?>"
            class=" badge badge-primary">Detail</a>
            &nbsp;
            <a href="#" data-toggle="modal" data-target="#modalcbcp" class="badge badge-danger">Upload Dokumen</a>
            &nbsp;
