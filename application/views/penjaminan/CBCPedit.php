                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input type="text" name="CBCPid" class="form-control" id="CBCPid"
                                value="<?=$this->uri->segment(3);?> " hidden>
                            <input style="width: 100%;" type="text" name="CBCPnomormemo" id="CBCPnomormemo"
                                class="form-control" value="<?=$table['CBCPnomormemo'];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="CBCPprinsipal" id="CBCPprinsipal"
                                class="form-control" value="<?=$table['CBCPprinsipal'];?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMalamat" id="TRJMalamat"
                                value="<?=$table['TRJMalamat'];?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMalamatsekarang" id="TRJMalamatsekarang"
                                value="<?=$table['TRJMalamatsaatini'];?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMusaha" id="TRJMusaha"
                                value="<?=$table['TRJMusaha'];?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">NPWP Pribadi</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMnpwp" id="TRJMnpwp"
                                value="<?=$table['TRJMnpwp'];?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMstatuspernikahan"
                                id="TRJMstatuspernikahan" value="<?=$table['TRJMstatuspernikahan'];?>"
                                class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
...
?>
                            <input style="width: 100%;" type="text" name="TRJMpartner" id="TRJMpartner"
                                value="<?=$query['TRJMnama'];?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Alamat Sesuai KTP</label>
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMalamatpartner" id="TRJMalamatpartner"
                                value="<?=$query['TRJMalamatsaatini'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="TRJMpekerjaanpartner"
                                id="TRJMpekerjaanpartner" value="<?=$query['TRJMpekerjaan'];?>" class="form-control">
                        </div>
                    </div>
                    <hr class="sidebar-divider">
                    <!-- End Body Terjamin -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="CBCPjenis" id="CBCPjenis"
                                value="<?=$table['CBCPjenis'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="CBCPsifat" id="CBCPsifat"
                                value="<?=$table['CBCPsifat'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="CBCPplafondkredit" id="CBCPplafondkredit"
                                value="<?=$table['CBCPplafondkredit'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" name="CBCPjwk" id="CBCPjwk"
                                value="<?=$table['CBCPjwk'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="number" name="CBCPangsurankredit" id="CBCPangsurankredit"
                                value="<?=$table['CBCPangsurankredit'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="CBCPrencanakredit" id="CBCPrencanakredit" class="form-control" rows="4"
                                cols="50"><?=$table['CBCPrencanakredit'];?>
                        </textarea>
                        </div>
                    </div>
                    <hr class="sidebar-divider">
...
?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input type="text" name="PPid" class="form-control" id="PPid" value="<?=$table['PPid'];?>"
                                hidden>
                            <input type="text" name="PPnama" class="form-control" value="<?=$querypp['PPnama'];?>"
                                id="PPnama">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="PPalamat" class="form-control"
                                readonly><?=$querypp['PPalamat'];?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="PPtelpon" name="PPtelpon"
                                value="<?=$querypp['PPtelpon'];?>" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPsiup" name="CBCPsiup"
                                value="<?=$table['TRJMsiup'];?>" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="CBCPdeskripsisumberpendapatan" id="CBCPdeskripsisumberpendapatan"
                                class="form-control"><?=$table['CBCPdeskripsisumberpendapatan'];?></textarea>
                        </div>
                    </div>
                    <hr class="sidebar-divider">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="CBCPdeskripsiusaha"
                                class="form-control"><?=$table['CBCPdeskripsiusaha'];?></textarea>
                        </div>
                    </div>
                    <hr class="sidebar-divider">
...
foreach ($JA->result_array() as $row) {
	?>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="CBCPjenisagunan[]"
                                class="form-control"> <?=$row['JAjenisagunan'];?> </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaitasaksi[]"
                                name="CBCPnilaitasaksi[]" value="<?=$row['JAnilaitasaksi'];?>">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaitasaksitanah[]"
                                name="CBCPnilaitasaksitanah[]" value="<?=$row['JAnilaitasaksitanah'];?>"
                                placeholder="Tanah/m">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaitasaksibangunan[]"
                                name="CBCPnilaitasaksibangunan[]" value="<?=$row['JAnilaitasaksibangunan'];?>"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaidasar[]"
                                name="CBCPnilaidasar[]" value="<?=$row['JAnilaidasar'];?>">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaidasartanah[]"
                                name="CBCPnilaidasartanah[]" value="<?=$row['JAnilaidasartanah'];?>"
                                placeholder="Nilai Dasar Tanah/m">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnilaidasarbangunan[]"
                                name="CBCPnilaidasarbangunan[]" value="<?=$row['JAnilaidasarbangunan'];?>"
                                placeholder="Nilai Dasar Bangunan">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="CBCPanalisadokumenidentitas"
                                class="form-control"><?=$table['CBCPanalisadokumenidentitas'];?></textarea>
                        </div>
                    </div>
                    <!-- Looping Bank -->
                    <?php
...
foreach ($OJK->result_array() as $OJKqry) {
	?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <textarea name="CBCPanalisaslikojk"
                                class="form-control"> <?=$OJKqry['CBCPojkanalisaslikojk'];?> </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPojkplafondkredit[]"
                                name="CBCPojkplafondkredit[]" value="<?=$OJKqry['CBCPojkplafondkredit'];?>"
                                placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPojktunggakanpokok[]"
                                name="CBCPojktunggakanpokok[]" value="<?=$OJKqry['CBCPojktunggakanpokok'];?>"
                                placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPojktunggakanbunga[]"
                                name="CBCPojktunggakanbunga[]" value="<?=$OJKqry['CBCPojktunggakanbunga'];?>"
                                placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPsumberpendapatan[]"
                                name="CBCPsumberpendapatan[]" value="<?=$pendapatanqry['CBCPsumberpendapatan'];?>"
                                placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnamapendapatan[]"
                                name="CBCPnamapendapatan[]" value="<?=$pendapatanqry['CBCPnamapendapatan'];?>"
                                placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPpendapatanbulan[]"
                                name="CBCPpendapatanbulan[]" value="<?=$pendapatanqry['CBCPpendapatanbulan'];?>"
                                placeholder="">
                        </div>
                    </div>
                    <?php }?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPnamapengeluaran[]"
                                name="CBCPnamapengeluaran[]" value="<?=$pengeluaranqry['CBCPnamapengeluaran'];?>"
                                placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group col-lg-3 col-sm-4">
                            <input style="width: 100%;" type="text" class="form-control" id="CBCPpengeluaranbulan[]"
                                name="CBCPpengeluaranbulan[]" value="<?=$pengeluaranqry['CBCPpengeluaranbulan'];?>"
                                placeholder="">
                        </div>
                    </div>
                    <?php }?>
