...
foreach ($table->result() as $u) {
	echo $u->TRJMnama;
}?>, dengan ini kami sampaikan gambaran singkat analisa untuk calon terjamin berdasarkan survei <i> on desk </i> yang
                    kami lakukan tanggal 18 Februari 2021 :
...
?>
        ...
        <table cellspacing="0" style="width: 100%; text-align: left;">
            ...
            <tr>
                <td height="300px"></td>
                <td style="width: 100%; text-align: left;"><b><u> Samuel P </u></b><br>Plt. Kepala Divisi Penjaminan
                </td>
                <td></td>
        ...
        <table align="center" cellspacing="0" style="width: 50%; text-align: center; ">
            <tr>
                ...
                <td>
                    <U><span style="font-weight: bold; font-size: 11pt;  color: #000000"><br><br>LEMBAR
                            PERSETUJUAN</span></U><br>
