...
class Fee_baru extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('operasional/fee_baru', $data);
    ...
    public function triggeredExport()
    {
        ...
        if ($clickEvent == 1) {
            ...
            $log = "User: " . $_SERVER['REMOTE_ADDR'] . ' - ' . date("F j, Y, H:i:s") . PHP_EOL .
                "Attempt: " . ("Success Export Fee") . PHP_EOL .
                "User: " . $namauser['nama'] . PHP_EOL .
    ...
    public function export($dataTable, $dataBulan)
    {
        ...
        foreach ($table_result as $u) {
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('H' . $kolom, "Rp." . number_format($u->DJPDfeebank, 0, ".", "."))
                ->setCellValue('I' . $kolom, "Rp." . number_format($angsuran = (int) ($u->DJPDfeebank / $u->DJPDjangkawaktu), 0, ".", "."));
            ...
            for ($i = 0; $i <= $u->DJPDjangkawaktu; $i++) {
                ...
                if ($newtime == $tglakhir) {
                    ...
                    for ($i = 0; $i <= $u->DJPDjangkawaktu; $i++) {
                        $spreadsheet->setActiveSheetIndex(0)->setCellValue($alphabet2 . $kolom, "Rp." . number_format($angsuran = (int) ($u->DJPDfeebank / $u->DJPDjangkawaktu), 0, ".", "."));
        ...
        header('Content-Disposition: attachment;filename="FeeAccrual.xls"');
