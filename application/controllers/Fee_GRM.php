...
class Fee_GRM extends CI_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Model_fee_grm');
        $this->load->model('Model_table_fee_grm');
    ...
    public function index()
    {
        ...
        if (!empty($this->input->post('Month')) && ($this->input->post('Month') == "00")) {
            ...
            if (!empty($this->input->post('GPPchecked')) && !empty($this->input->post('OPKchecked'))) {
                ...
                $data['ambilid'] = $this->Model_fee_grm->ambilid();

                $data['table'] = $this->Model_table_fee_grm->ambil_data_query_lengkap($keyword, $GPPchecked, $OPKchecked, $Tahunchecked); // pass value to model fn
                ...
                $data['table'] = $this->Model_table_fee_grm->ambil_data_query_opk($keyword, $OPKchecked, $Tahunchecked); // pass value to model fn
                ...
                $keyword = $this->input->post('keyword');
                $data['ambilid'] = $this->Model_fee_grm->ambilid();
                $data['table'] = $this->Model_table_fee_grm->ambil_data($keyword);
                ...
                $data['table'] = $this->Model_table_fee_grm->ambil_data_query($keyword, $GPPchecked, $Tahunchecked); // pass value to model fn
            ...
            if (!empty($this->input->post('GPPchecked')) && !empty($this->input->post('OPKchecked'))) {
                ...
                $data['table'] = $this->Model_table_fee_grm->ambil_data_query_lengkap_bulan($keyword, $GPPchecked, $OPKchecked, $totalBulan, $Tahunchecked); // pass value to model fn
                ...
                $data['table'] = $this->Model_table_fee_grm->ambil_data_query_opk_bulan($keyword, $OPKchecked, $totalBulan, $Tahunchecked); // pass value to model fn
                ...
                $keyword = $this->input->post('keyword');
                $data['ambilid'] = $this->Model_fee_grm->ambilid();
                $data['table'] = $this->Model_table_fee_grm->ambil_data_bulan($keyword, $totalBulan, $Tahunchecked);
                ...
                $data['table'] = $this->Model_table_fee_grm->ambil_data_query_bulan($keyword, $GPPchecked, $totalBulan, $Tahunchecked); // pass value to model fn
        ...
        $data['gpp'] = $this->Model_table_fee_grm->getGPP();
        $data['opk'] = $this->Model_table_fee_grm->getOPK();
        $data['tahun'] = $this->Model_table_fee_grm->getYear();
        ...
        $this->load->view('operasional/fee_grm', $data);
